                        ...
                        {profile ? (
                            ...
                            >
                                ...
                                {singleUserDetail.avatar ? (
                                    <>
                                        <img
                                            src={process.env.REACT_APP_IMAGE_BASE_URL+`/${singleUserDetail.avatar}`}
                                            alt=""
                                            width={190}
                                            height={190}
                                        />
                                    ...
                                    <><EditIcon className="editIcon" color="action" /><img src="/assets/images/avatar.png" alt="User" /></>
                                )}
                            </div>
                        )}
                            ...
                            {companyLogo ? (
                                ...
                                >
                                    ...
                                    {singleUserDetail.company_logo ? (
                                        <>
                                            <img
                                                src={process.env.REACT_APP_IMAGE_BASE_URL+`/${singleUserDetail.company_logo}`}
                                                alt=""
                                                width={190}
                                                height={190}
                                            />
